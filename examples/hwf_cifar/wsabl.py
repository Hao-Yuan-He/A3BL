...
from models.nn import SymbolNet, ResNet50
import numpy as np
import torch
...
def main(args):
    ...
    cls = ResNet50(num_classes=len(kb.pseudo_label_list))
    ...
    metric = [SymbolMetric(prefix="HWF-CIFAR"), ABLMetric(prefix="HWF-CIFAR")]
...
def get_args():
    ...
    parser.add_argument("--dataset", type=str, default="HWF-CIFAR")
